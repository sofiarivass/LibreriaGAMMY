...
public class AnularVentaLocal extends JFrame {
	...
	public AnularVentaLocal(Usuario user) {
		...
		model = new DefaultTableModel(new String[]{"ID-VENTA", "FECHA-VENTA", "METODO-PAGO", "TIPO-MONEDA", "ESTADO"}, 0);
		...
		btnAnular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (venta != null) {
					...
					if (VentasLocalDTO.anularVentaLocalJframe(venta)) {
		...
		table.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (row != -1) {
                	...
                	for (Venta libro : listaVentas) {    // esto es la fila del id
